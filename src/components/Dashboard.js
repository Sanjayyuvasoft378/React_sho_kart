    ...
    <div>
      <div className="container-fluid">
        <div className="row bg-secondary py-1 px-xl-5">
          <div className="col-lg-6 d-none d-lg-block">
            <div className="d-inline-flex align-items-center h-100" style={{gap: "20px", float: "left"}}>
          ...
          <div className="col-lg-6 text-center text-lg-right">
            <div className="d-inline-flex align-items-center" style={{gap: "20px", float: "right"}}>
      ...
      <div className="container-fluid mb-3">
        <div className="row px-xl-5">
              ...
              <div className="carousel-inner">
                ...
                >
                  <img
                    ...
                    src="assets/img/carousel-1.jpg" style={{display: "block",width:"100px"}}
                  />
          ...
          <div className="col-lg-4">
            <div className="product-offer mb-30" style={{ height: "220px", marginTop: "20px", cursor: "pointer"}}>
            ...
            <div className="product-offer mb-30" style={{ height: "200px"  ,cursor: "pointer" }}>
